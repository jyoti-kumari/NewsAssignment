...
class HeadlineRepositoryTest: XCTestCase {
    ...
    func testAPIRequestSuccess() {
        ...
        let headlineRemoteRepo = HeadlineRepository(apiService: service)
        
        // When
        let expectation = XCTestExpectation(description: "API request")
        let promise: Promise<[HeadlineData]> = headlineRemoteRepo.getHeadlines()
